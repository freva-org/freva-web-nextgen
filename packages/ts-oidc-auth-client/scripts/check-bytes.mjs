 ...
 *
 * A literal control character inside a regex character class makes a source
 * file "binary" to git and to review tooling - the diff is unreadable and the
 * security-critical code is effectively unreviewable.
 */
